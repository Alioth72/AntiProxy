...
class FaceRecognitionAPIClient:
    ...
    def __init__(self, api_url="https://face-detection-flask-998646310802.asia-south2.run.app/recognize_faces"):
        """
...
def main():
    ...
    parser.add_argument("--api-url", default="https://face-detection-flask-998646310802.asia-south2.run.app/recognize_faces", 
