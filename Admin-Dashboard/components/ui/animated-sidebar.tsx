...
export const DesktopSidebar = ({ className, children, ...props }: React.ComponentProps<typeof motion.div>) => {
  ...
  return (
    <motion.div
      className={cn("h-full px-4 py-4 hidden md:flex md:flex-col bg-neutral-900 w-[300px] flex-shrink-0", className)}
      animate={{
...
export const MobileSidebar = ({ className, children, ...props }: React.ComponentProps<"div">) => {
  ...
  return (
    <>
      <div
        className={cn("h-14 px-4 py-4 flex flex-row md:hidden items-center justify-between bg-neutral-900 w-full")}
        {...props}
      >
